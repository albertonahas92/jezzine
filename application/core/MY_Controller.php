...
class MY_Controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        foreach ($settings as $setting)
        {
            ...
            $this->settings->{$setting['name']} = (@unserialize($setting['image']) !== false) ? unserialize($setting['image']) : $setting['image'];
        }
        ...
        $this
            ->add_external_css(
                array(
                    ...
                    "//fonts.googleapis.com/css?family=Quattrocento:400,700&amp;subset=latin-ext",
                    "//fonts.googleapis.com/css?family=Montserrat",
                  
                  
                    "//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css",
                    base_url("/{$this->settings->themes_folder}/default/node_modules/bootstrap-grid-only/bootstrap.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/reset.css"),
                    ...
                    base_url("/{$this->settings->themes_folder}/default/css/main.css?v=123"),
                    
                    base_url("/{$this->settings->themes_folder}/default/css/side.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/animate.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/iziModal.min.css")
            ...
            ->add_external_js(
                array(
                 ...
                 //   "https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js",
                    ...
                    base_url("/{$this->settings->themes_folder}/default/js/iziModal.min.js"),
                    ...
                    base_url("/{$this->settings->themes_folder}/default/js/app.js"),
		...
		$core_js = $this->jsi18n->translate("/{$this->settings->themes_folder}/default/js/main.js");
		$core_js = str_replace("<<base_url>>", base_url(), $core_js);


        $wow_js = $this->jsi18n->translate("/{$this->settings->themes_folder}/default/js/wow.min.js");
        $wow_js = str_replace("<<base_url>>", base_url(), $wow_js);
